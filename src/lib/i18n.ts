...
export const UI_TEXT: Record<LangCode, Record<string, string>> = {
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__unlock_at": "Unlocks at {amount}",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Наші проєкти",
    "projects__subtitle": "Запущені та майбутні продукти екосистеми MAGIC TIME",
    "projects__raised": "Зібрано",
    "projects__seg_seed": "Старт",
    "projects__seg_grow": "Зростання",
    "projects__seg_scale": "Масштаб",
    "projects__seg_ecosystem": "Екосистема",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Продукт уже працює — натисніть, щоб відкрити.",
    "projects__open": "Відкрити →",
    "projects__live": "Працює",
    "projects__coming_soon": "Скоро",
    "projects__locked": "Заблоковано",
    "projects__unlock_at": "Відкриється при {amount}",
    "projects__p2": "Проєкт №2",
    "projects__p3": "Проєкт №3",
    "projects__p4": "Проєкт №4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Наши проекты",
    "projects__subtitle": "Запущенные и будущие продукты экосистемы MAGIC TIME",
    "projects__raised": "Собрано",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "Рост",
    "projects__seg_scale": "Масштаб",
    "projects__seg_ecosystem": "Экосистема",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Продукт уже работает — нажмите, чтобы открыть.",
    "projects__open": "Открыть →",
    "projects__live": "Работает",
    "projects__coming_soon": "Скоро",
    "projects__locked": "Заблокировано",
    "projects__unlock_at": "Откроется при {amount}",
    "projects__p2": "Проект №2",
    "projects__p3": "Проект №3",
    "projects__p4": "Проект №4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Nuestros proyectos",
    "projects__subtitle": "Productos lanzados y próximos en el ecosistema MAGIC TIME",
    "projects__raised": "Recaudado",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "Crecimiento",
    "projects__seg_scale": "Escala",
    "projects__seg_ecosystem": "Ecosistema",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Producto en vivo — haz clic para abrirlo.",
    "projects__open": "Abrir →",
    "projects__live": "En vivo",
    "projects__coming_soon": "Próximamente",
    "projects__locked": "Bloqueado",
    "projects__unlock_at": "Se desbloquea a {amount}",
    "projects__p2": "Proyecto #2",
    "projects__p3": "Proyecto #3",
    "projects__p4": "Proyecto #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Nos projets",
    "projects__subtitle": "Produits lancés et à venir dans l’écosystème MAGIC TIME",
    "projects__raised": "Collecté",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "Croissance",
    "projects__seg_scale": "Échelle",
    "projects__seg_ecosystem": "Écosystème",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Produit en ligne — cliquez pour l’ouvrir.",
    "projects__open": "Ouvrir →",
    "projects__live": "En ligne",
    "projects__coming_soon": "Bientôt",
    "projects__locked": "Verrouillé",
    "projects__unlock_at": "Débloqué à {amount}",
    "projects__p2": "Projet #2",
    "projects__p3": "Projet #3",
    "projects__p4": "Projet #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Nossos projetos",
    "projects__subtitle": "Produtos lançados e futuros no ecossistema MAGIC TIME",
    "projects__raised": "Arrecadado",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "Crescer",
    "projects__seg_scale": "Escalar",
    "projects__seg_ecosystem": "Ecossistema",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Produto ao vivo — clique para abrir.",
    "projects__open": "Abrir →",
    "projects__live": "Ao vivo",
    "projects__coming_soon": "Em breve",
    "projects__locked": "Bloqueado",
    "projects__unlock_at": "Desbloqueia em {amount}",
    "projects__p2": "Projeto #2",
    "projects__p3": "Projeto #3",
    "projects__p4": "Projeto #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "我们的项目",
    "projects__subtitle": "MAGIC TIME 生态中已上线与即将推出的产品",
    "projects__raised": "已筹集",
    "projects__seg_seed": "种子",
    "projects__seg_grow": "增长",
    "projects__seg_scale": "规模化",
    "projects__seg_ecosystem": "生态",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "已上线产品 — 点击打开。",
    "projects__open": "打开 →",
    "projects__live": "已上线",
    "projects__coming_soon": "即将推出",
    "projects__locked": "已锁定",
    "projects__unlock_at": "达到 {amount} 解锁",
    "projects__p2": "项目 #2",
    "projects__p3": "项目 #3",
    "projects__p4": "项目 #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "हमारे प्रोजेक्ट",
    "projects__subtitle": "MAGIC TIME इकोसिस्टम में लॉन्च हुए और आने वाले प्रोडक्ट्स",
    "projects__raised": "जुटाया गया",
    "projects__seg_seed": "सीड",
    "projects__seg_grow": "ग्रोथ",
    "projects__seg_scale": "स्केल",
    "projects__seg_ecosystem": "इकोसिस्टम",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "लाइव प्रोडक्ट — खोलने के लिए क्लिक करें।",
    "projects__open": "खोलें →",
    "projects__live": "लाइव",
    "projects__coming_soon": "जल्द आ रहा",
    "projects__locked": "लॉक्ड",
    "projects__unlock_at": "{amount} पर अनलॉक होगा",
    "projects__p2": "प्रोजेक्ट #2",
    "projects__p3": "प्रोजेक्ट #3",
    "projects__p4": "प्रोजेक्ट #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "Proyek kami",
    "projects__subtitle": "Produk yang sudah rilis dan yang akan datang dalam ekosistem MAGIC TIME",
    "projects__raised": "Terkumpul",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "Tumbuh",
    "projects__seg_scale": "Skala",
    "projects__seg_ecosystem": "Ekosistem",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "Produk live — klik untuk membuka.",
    "projects__open": "Buka →",
    "projects__live": "Live",
    "projects__coming_soon": "Segera hadir",
    "projects__locked": "Terkunci",
    "projects__unlock_at": "Terbuka pada {amount}",
    "projects__p2": "Proyek #2",
    "projects__p3": "Proyek #3",
    "projects__p4": "Proyek #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "مشاريعنا",
    "projects__subtitle": "المنتجات التي أُطلقت والقادمة ضمن منظومة MAGIC TIME",
    "projects__raised": "تم جمع",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "نمو",
    "projects__seg_scale": "توسّع",
    "projects__seg_ecosystem": "منظومة",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "منتج متاح الآن — اضغط لفتحه.",
    "projects__open": "افتح →",
    "projects__live": "متاح",
    "projects__coming_soon": "قريبًا",
    "projects__locked": "مقفل",
    "projects__unlock_at": "سيفتح عند {amount}",
    "projects__p2": "المشروع #2",
    "projects__p3": "المشروع #3",
    "projects__p4": "المشروع #4",
    "trust_title": "Why trust us",
  ...
  "calc__estimation_note": "* Estimation. Final amount depends on tx + rounding.",
    ...
    "projects__title": "আমাদের প্রকল্পসমূহ",
    "projects__subtitle": "MAGIC TIME ইকোসিস্টেমের চালু ও আসন্ন প্রোডাক্টসমূহ",
    "projects__raised": "সংগৃহীত",
    "projects__seg_seed": "Seed",
    "projects__seg_grow": "বৃদ্ধি",
    "projects__seg_scale": "স্কেল",
    "projects__seg_ecosystem": "ইকোসিস্টেম",
    "projects__tap_title": "MAGIC TIME TAP",
    "projects__tap_desc": "লাইভ প্রোডাক্ট — খুলতে ক্লিক করুন।",
    "projects__open": "খুলুন →",
    "projects__live": "লাইভ",
    "projects__coming_soon": "শীঘ্রই",
    "projects__locked": "লকড",
    "projects__unlock_at": "{amount} এ আনলক হবে",
    "projects__p2": "প্রকল্প #2",
    "projects__p3": "প্রকল্প #3",
    "projects__p4": "প্রকল্প #4",
    "trust_title": "Why trust us",
