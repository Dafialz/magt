...
export function Header({
  lang,
  onLangChange,
  // ✅ backward/compat: allow passing setLang instead of onLangChange
  setLang,
}: {
  lang: LangCode;
  ...
  const changeLang = (v: LangCode) => {
    (onLangChange ?? setLang)?.(v);
  };
    ...
    <header className="sticky top-0 z-20 border-b border-zinc-900 bg-zinc-950/70 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <LangSwitcher value={lang} onChange={changeLang} />
          <TonConnectButton />
        </div>
